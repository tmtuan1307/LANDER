...
--exp_name=nayeravg_c100_fr1_ln1_r0_bn10_g40_n10k_lr4e2 --type -1 --bn 10 --num_users 5 --fr 1 --syn_round 50 --swp 10 --lte_norm 1 \
--com_round 100 --g_steps 40 --local_lr 4e-2 --spec lt1 --shift_r 1.0 --cer 0.0 --ls 0.0